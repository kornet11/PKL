...
<body>
	...
	<div class="container">
		<div class="card">
		  <div class="card-header bg-success text-center text-white">
		  	<div class="row">
		  		...
		  		<div class="col-10">
		  			<span class="fs-5">Kartu Anggota Perpustakaan</span><br>
				    <span class="fw-semibold fs-4">SMK Mamba'ul Ihsan</span><br>
				    <span>Jln Banyuuurip Ujngpangkah Gresik Jawa Timur</span>
		  		</div>
		  	</div>
		  </div>
		  <div class="card-body" style="background-image: linear-gradient(white 70%,#A0FBCF);">
		  	<?php 
		  	$a = mysqli_query($conn, "SELECT * FROM dudi WHERE id_dudi = $id");
		  	while( $dataA = mysqli_fetch_assoc($a) ) :
		  	?>
		  	<div class="row">
		  		<div class="col-3">
		  			<img src="assets/img/anggota/<?= $dataA['logo']; ?>" width="100" class="mt-2">
		  		</div>
		  		<div class="col-9">
		...
		<a href="cetakKartu.php?id=<?= $id; ?>" class="btn btn-success" target="_blank">Cetak Kartu</a>
	</div>
