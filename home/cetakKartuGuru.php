...
<head>
	...
	<title>Cetak Kartu Guru Pembimbing</title>
...
<body>
	...
	<div class="container">
		<div class="card">
			<div class="card-header bg-success text-center text-white">
				<div class="row">
					...
					<div class="col-10">
						<span class="fs-5">Kartu Guru Pembimbing</span><br>
			...
			<div class="card-body" style="background-image: linear-gradient(white 70%,#A0FBCF);">
				<?php
				$a = mysqli_query($conn, "SELECT * FROM gurupembimbing WHERE id_gurupem = '$id'");
		...
		<a href="cetakKartuG.php?id=<?= $id; ?>" class="btn btn-success" target="_blank">Cetak Kartu</a>
	</div>
